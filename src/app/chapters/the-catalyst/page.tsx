    ...
    <div className="relative flex min-h-[70vh] flex-col items-center justify-center text-center">
      ...
      <motion.div style={{ opacity: textOpacity }} className="relative z-10 select-none max-w-3xl">
        <div className="mb-6 flex justify-center">
          <Kicker>Chapter 04 / Reading the Scheme</Kicker>
        </div>
      ...
      <div className="relative flex items-center justify-center rounded-2xl border border-white/5 bg-space-panel p-6 min-h-[340px] overflow-hidden">
        <div className="w-full max-w-xs text-center space-y-6 font-mono text-[10px] uppercase tracking-wider">
          <div className="flex justify-center items-center gap-2">
            {[1, 2, 3, 4, 5].map((i) => (
              <circle key={i} cx="0" cy="0" r="10" className="stroke-white/30 fill-white/5 border text-[7px] flex items-center justify-center h-7 w-7 rounded-full font-bold animate-pulse">
                P
              </circle>
            ))}
          </div>
...
/* ==========================================================================
   SCENE 9: ENDING CARD (Transition link to Chapter 5: misconceptions)
   ========================================================================== */
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
      ...
      <div className="mt-8 space-y-4">
        ...
        >
          Now that we understand the legal and prospectus checks, we challenge the standard industry myth: is a demerger merely accounting cosmetic surgery, or is it something deeper?
        </motion.p>
      </div>

      {/* Chapter 5 Navigation Callout */}
      <motion.div
      ...
      >
        <Link
          href="/chapters/the-misconception"
