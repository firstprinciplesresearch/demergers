  ...
  const scenes: DeckScene[] = [
    {
      ...
      render: (active) => (
        <CinematicHeroScene active={active} controller={controller} />
      ),
    },
    {
      id: "presenter",
      name: "The Presenter",
      render: (active) => (
        <PresenterProfileScene active={active} controller={controller} />
      ),
    },
    {
      id: "disclaimer",
      name: "Disclaimer",
      render: (active) => (
        <DisclaimerScene active={active} controller={controller} />
      ),
    },
    {
      id: "quote",
      name: "The Reframe",
      render: (active) => (
        <HeroQuoteScene active={active} controller={controller} />
      ),
    },
    {
      id: "chart",
      name: "The Evidence",
      render: (active) => (
        <PerformanceChartScene active={active} controller={controller} />
      ),
    },
    {
      id: "india",
      name: "India Proof",
      render: (active) => (
        <IndiaMapScene active={active} controller={controller} />
      ),
    },
    {
      id: "tracker",
      name: "The Tracker",
      render: (active) => (
        <DemergerTrackerScene active={active} controller={controller} />
      ),
    },
    {
      id: "ending",
...
function HeroQuoteScene({
  ...
  const quoteOpacity = useTransform(
    progress,
    [seg * index, seg * index + seg * 0.9, seg * (index + 1)],
    [1, 1, 0.25],
  );
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto flex items-center justify-center min-h-[70vh]">
      ...
      <motion.div
        ...
        animate={
          active ? { scale: 1.12, opacity: 0.4 } : { scale: 1, opacity: 0.25 }
        }
          ...
          <h1 className="text-balance text-4xl font-black uppercase leading-[0.9] tracking-tighter sm:text-5xl md:text-7xl">
            {quoteWords.map((word, i) => (
              <motion.span
                ...
                className={cn(
                  "inline-block mr-2.5",
                  (word.toLowerCase().includes("fish") ||
                    word.toLowerCase().includes("are")) &&
                    "text-gradient-gold",
                )}
              >
                {word}
...
function AnimatedOceanScene({
  ...
  const boatXScroll = useTransform(
    progress,
    [seg * index, seg * (index + 1)],
    [10, 65],
  );
    ...
    const draw = () => {
      ...
      particles.forEach((p) => {
        ...
        const x =
          ...
          Math.sin(time + p.phase) * 5;
        const y =
          clusterY +
          p.radius * Math.sin(p.angle) * 0.65 +
          Math.cos(time + p.phase) * 3; // Elliptical cluster
  ...
  return (
    <div className="relative h-[80vh] w-full overflow-hidden rounded-2xl bg-space-dark border border-white/5">
      ...
      >
        <svg
          viewBox="0 0 48 32"
          className="h-10 w-10 text-white fill-none"
          stroke="currentColor"
          strokeWidth="1.5"
        >
          {/* Hull */}
          ...
          {/* Sail */}
          <path
            d="M22 6 L36 17 L22 17 Z"
            fill="rgba(255,255,255,0.1)"
            strokeWidth="1.5"
          />
          <path
            d="M22 6 C 28 10, 28 14, 22 17"
        ...
        {showText && (
          ...
          >
            ...
            <p className="mt-2 text-xs leading-relaxed text-white/50">
              Corporate spin-offs generate structural inefficiencies. By
              separating units, they create pockets of forced selling and
              mispriced complexity.
            </p>
          </motion.div>
        )}
      </AnimatePresence>
...
function IndiaMapScene({
  ...
  const pins: IndiaPin[] = [
    {
      city: "Mumbai",
      parentCo: "Reliance Industries",
      spinCo: "Jio Financial Services",
      x: 145,
      y: 435,
    },
    {
      city: "Bengaluru",
      parentCo: "Wipro Limited",
      spinCo: "Wipro Enterprises",
      x: 215,
      y: 575,
    },
    {
      city: "Chennai",
      parentCo: "IDFC Limited",
      spinCo: "IDFC First Bank",
      x: 275,
      y: 595,
    },
    {
      city: "Kolkata",
      parentCo: "ITC Limited",
      spinCo: "ITC Hotels (Pending)",
      x: 455,
      y: 365,
    },
    {
      city: "Ahmedabad",
      parentCo: "Adani Enterprises",
      spinCo: "Adani Green Energy",
      x: 135,
      y: 330,
    },
  ];
      ...
      <div className="relative flex items-center justify-center rounded-2xl border border-white/5 bg-space-panel p-6 min-h-[380px] overflow-hidden">
                ...
                >
                  ...
                  <circle
                    ...
                    className={cn(
                      ...
                      selectedPin === i
                        ? "fill-white r-[8.5]"
                        : "fill-accent-gold group-hover:fill-white",
                    )}
                  />
                  {/* Micro city label */}
                  <text
        ...
        <AnimatePresence>
          {selectedPin !== null && (
            ...
            >
              <div>
                <span className="font-mono text-[8px] uppercase tracking-widest text-accent-gold">
                  India Case Study
                </span>
      ...
      <div className="flex flex-col gap-6">
        ...
        >
          ...
          <h4 className="mt-2 text-base font-bold text-white leading-snug">
            Indian Demerger Evidence
          </h4>
          <p className="mt-1 text-xs text-white/50">
            Unifi Capital Special Situations Report
          </p>
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            "Conglomerate Discount Unlocked",
          ].map((takeaway, i) => (
            <motion.span
              key={takeaway}
              initial={{ opacity: 0, y: 10 }}
        ...
        {modalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-5 bg-space-black/90 backdrop-blur-md">
            ...
            >
              ...
              <span className="font-mono text-[9px] uppercase tracking-[0.24em] text-accent-gold">
                Unifi Research Summary
              </span>
              <h3 className="mt-2 text-xl font-black uppercase text-white tracking-tight">
                Corporate Restructuring in India
              </h3>

              <div className="mt-4 space-y-3.5 text-sm text-white/70 leading-relaxed">
                <p>
                  Unifi Capital analysis of over 40 corporate demergers in the
                  Indian market between 2012 and 2024 reveals key structural
                  tailwinds:
                </p>
                <ul className="list-disc pl-5 space-y-1.5 text-xs text-white/60">
                  <li>
                    <strong className="text-white">Management Focus:</strong>{" "}
                    Independent boards targeting distinct industry dynamics.
                  </li>
                  <li>
                    <strong className="text-white">Capital Efficiency:</strong>{" "}
                    Elimination of internal capital subsidies from highly
                    profitable core units to speculative subsidiaries.
                  </li>
                  <li>
                    <strong className="text-white">
                      Institutional Re-rating:
                    </strong>{" "}
                    Clean sector companies attract dedicated mutual fund
                    clusters restricted from investing in conglomerates.
                  </li>
                </ul>
                <p className="text-xs font-mono text-accent-gold">
                  Conclusion: Demerged Indian entities outpaced the Nifty 50 by
                  a median excess CAGR of 8.4% over 36 months post-listing.
                </p>
              </div>
...
function DemergerTrackerScene({
  ...
  const trackerItems: TrackerItem[] = [
    {
      company: "Aarti Ind. / Aarti Pharmalabs",
      announcement: "NSE:AARTIIND",
      recordDate: "13/02/2020",
      returns: 77.56,
      status: "Completed",
    },
    {
      company: "NMDC Ltd / NMDC Steel Ltd",
      announcement: "NSE:NMDC",
      recordDate: "27/01/2021",
      returns: 24.44,
      status: "Completed",
    },
    {
      company: "Mirza International / Red Tape",
      announcement: "NSE:MIRZAINT",
      recordDate: "10/12/2021",
      returns: 114.80,
      status: "Completed",
    },
    {
      company: "Shipping Corp / SCI Land & Assets",
      announcement: "NSE:SCI",
      recordDate: "31/03/2021",
      returns: 3.93,
      status: "Completed",
    },
    {
      company: "GHCL Ltd / GHCL Textiles",
      announcement: "NSE:GHCL",
      recordDate: "18/03/2020",
      returns: 448.76,
      status: "Completed",
    },
    {
      company: "Edelweiss / Nuvama Wealth",
      announcement: "NSE:EDELWEISS",
      recordDate: "13/05/2022",
      returns: 4.12,
      status: "Completed",
    },
    {
      company: "Reliance Ind. / Jio Financial",
      announcement: "NSE:RELIANCE",
      recordDate: "21/10/2022",
      returns: 2.34,
      status: "Completed",
    },
    {
      company: "Saregama / Digidrive Distrib.",
      announcement: "NSE:SAREGAMA",
      recordDate: "30/03/2022",
      returns: -11.46,
      status: "Completed",
    },
    {
      company: "TVS Holdings / Sundaram Clayton",
      announcement: "BOM:520056",
      recordDate: "09/02/2022",
      returns: 11.11,
      status: "Completed",
    },
    {
      company: "Bajaj Electricals / Bajel Projects",
      announcement: "NSE:BAJAJELEC",
      recordDate: "14/09/2022",
      returns: -19.81,
      status: "Completed",
    },
    {
      company: "Naperol Invest. / National Peroxide",
      announcement: "BOM:500298",
      recordDate: "17/02/2023",
      returns: -5.67,
      status: "Completed",
    },
    {
      company: "Forbes & Co / Forbes Precision Tools",
      announcement: "BOM:502865",
      recordDate: "26/09/2022",
      returns: 22.80,
      status: "Completed",
    },
    {
      company: "Ujaas Energy / Bluehope Solutions",
      announcement: "BOM:533644",
      recordDate: "13/10/2023",
      returns: 5.13,
      status: "Completed",
    },
    {
      company: "Vikram Thermo / Vikram Aroma",
      announcement: "BOM:530477",
      recordDate: "17/09/2022",
      returns: 176.27,
      status: "Completed",
    },
    {
      company: "Sanofi India / Sanofi Consumer",
      announcement: "NSE:SANOFI",
      recordDate: "10/05/2023",
      returns: 46.89,
      status: "Completed",
    },
    {
      company: "Oriental Carbon / AG Ventures",
      announcement: "BOM:506579",
      recordDate: "24/05/2022",
      returns: -8.19,
      status: "Completed",
    },
    {
      company: "Ajmera Realty / Radha Ram Dev",
      announcement: "NSE:AJMERA",
      recordDate: "13/01/2020",
      returns: 404.93,
      status: "Completed",
    },
    {
      company: "RDB Realty / RDB Real Estate",
      announcement: "BOM:533285",
      recordDate: "17/12/2022",
      returns: 271.13,
      status: "Completed",
    },
  ];
    ...
    <div className="grid gap-6 md:grid-cols-[280px_1fr] md:items-center">
      ...
      <div className="flex flex-col gap-4">
        <div className="mb-2">
          ...
          <h3 className="mt-1 text-2xl font-black uppercase text-white tracking-tight">
            Our Tracker
          </h3>
          <p className="mt-1 text-xs text-white/50 leading-relaxed">
            Real-time pipeline monitoring across parent stubs, corporate spin-co
            announcements, and upcoming record dates.
          </p>
        </div>
      ...
      <div className="relative rounded-xl border border-white/10 bg-[#020206] p-4 overflow-hidden shadow-2xl">
        ...
        <div className="relative h-[220px] overflow-hidden">
          <div className="flex flex-col gap-1.5 animate-[marquee-vertical_36s_linear_infinite] hover:[animation-play-state:paused]">
            {/* Iteration 1 */}
...
function TrackerRow({ item, flash }: { item: TrackerItem; flash?: boolean }) {
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-[2fr_1.2fr_1.1fr_0.9fr_0.8fr] gap-3 items-center rounded-lg border border-white/5 bg-space-panel/40 px-3 py-2 text-xs transition-colors duration-500",
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto">
      ...
      <motion.div
        ...
        animate={
          active ? { scale: 1.08, opacity: 0.35 } : { scale: 1, opacity: 0.2 }
        }
        transition={{ duration: 6, ease: "easeOut" }}
        className="radial-vignette pointer-events-none absolute inset-0 bg-radial from-accent-gold/5 via-transparent to-transparent"
      />
        ...
        <div className="flex flex-col text-left">
          ...
          >
            <p className="text-xs md:text-sm font-semibold italic text-emerald-400">
              &ldquo;An idea can change your life, a perspective can change your
              portfolio.&rdquo;
            </p>
          </motion.div>
        </div>
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto pb-4">
      ...
      <motion.div
        ...
        animate={
          active ? { scale: 1.05, opacity: 0.3 } : { scale: 1, opacity: 0.15 }
        }
        transition={{ duration: 6, ease: "easeOut" }}
        className="radial-vignette pointer-events-none absolute inset-0 bg-radial from-accent-gold/5 via-transparent to-transparent"
      />
      ...
      <div className="relative z-10 grid gap-6 md:grid-cols-[1fr_1.4fr] md:gap-10 items-center">
        ...
        <div className="flex flex-col text-left">
          ...
          <motion.div
            ...
            animate={
              active ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.96 }
            }
          ...
          >
            ...
            <div className="pl-3">
              ...
              <p className="mt-1.5 text-[11px] font-semibold leading-relaxed text-accent-gold">
                The speaker and / or associated persons may hold positions in
                one or more of the securities mentioned, and those positions may
        ...
        <div className="flex flex-col text-left text-[11px] md:text-xs leading-relaxed text-white/70 space-y-3">
          ...
          >
            ...
            and does not constitute investment advice, a research report, or a
            recommendation to buy, sell, or hold any security. It is not a
            solicitation or offer to deal in any security. The companies,
            sectors, and securities discussed are referenced solely to
            illustrate the analytical framework and themes presented; their
          ...
          >
            All information drawn from sources believed to be reliable and from
            publicly available primary documents, but no representation or
            warranty, express or implied, is made as to its accuracy,
            completeness, or timeliness. Forward-looking statements and
            management guidance referenced herein are subject to change and
          ...
          >
            Investing in securities carries risk, including possible loss of
            principal. Recipients should conduct their own independent due
            diligence and consult a SEBI-registered investment adviser before
            making any investment decision. The speaker accepts no liability for
            any loss arising from reliance on this material.
          </motion.p>
        </div>
      </div>
      ...
      {active && (
        <motion.div
          ...
          style={{
            background:
              "repeating-linear-gradient(-45deg, #ffb800, #ffb800 12px, #030308 12px, #030308 24px)",
          }}
        />
      )}
    </div>
